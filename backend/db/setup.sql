...
CREATE TABLE IF NOT EXISTS LostRequest (
    RequestID INT PRIMARY KEY NOT NULL AUTO_INCREMENT, Requester_ID VARCHAR(255), ItemName VARCHAR(255), Description TEXT, DateLost DATE, Location VARCHAR(255), Status VARCHAR(255), FOREIGN KEY (Requester_ID) REFERENCES Employee (Employee_ID)
);
...
INSERT INTO
    Item (
        ItemName, Status, Image, Description, DateFound, Location, PostE_ID
    )
VALUES (
        'Keys Set', 'Unclaimed', 'keys.jpg', 'A set of keys with a superhero keychain, found in the cafeteria.', '2024-04-10', 'Cafeteria', "002828141"
    ),
    (
        'Basketball', 'Unclaimed', 'basketball.jpg', 'A basketball found in the gym.', '2024-04-10', 'Gym', "002828141"
    ),
    (
        'Ocean', 'Unclaimed', 'basketball.jpg', 'Ocean is my son.', '2024-04-10', 'Library', "002828141"
    );
